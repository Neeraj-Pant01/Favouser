    ...
    <div className="bg-gray-900 text-white min-h-screen px-3 md:px-10 py-16">
      <div className=" mx-auto space-y-16">
        ...
        <div className="text-center">
          <h1 className="text-4xl md:text-5xl font-extrabold text-yellow-400 mb-4">About Us – Favouser</h1>
        ...
        <div className="space-y-12">
          {/* Our Story */}
          <section>
            <h2 className="text-2xl font-semibold text-yellow-300 mb-2">🌟 Our Story</h2>
          ...
          {/* What We Do */}
          <section>
            <h2 className="text-2xl font-semibold text-yellow-300 mb-2">👕 What We Do</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          {/* Made in India */}
          <section>
            <h2 className="text-2xl font-semibold text-yellow-300 mb-2">🌏 Made in India, Made for Everyone</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          {/* Why You'll Love Us */}
          <section>
            <h2 className="text-2xl font-semibold text-yellow-300 mb-2">❤️ Why You'll Love Us</h2>
          ...
          <div className="text-center pt-6">
            <h2 className="text-3xl font-bold text-yellow-400">Who We Are</h2>
          </div>
